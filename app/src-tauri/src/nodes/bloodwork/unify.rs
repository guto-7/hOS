...
pub struct BloodworkData {
    ...
    pub markers: Vec<BloodworkMarker>,
...
/// Unify raw bloodwork data by reading the enriched Stage 2 output from Python.
...
pub fn unify(raw: &RawData) -> Result<BloodworkData, PipelineError> {
...
fn parse_markers_from_content(content: &serde_json::Value) -> Vec<BloodworkMarker> {
